    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("👩‍👩‍👦‍👦Group", url="https://t.me/Movie360hub"),
                        InlineKeyboardButton("🔊Channel", url="https://t.me/joinchat/KxAoLQwjtFY2YjM1")
                    ],
                    [
                        InlineKeyboardButton("💻 Tutorial Video 💻", url="https://youtu.be/GWNEMhIhMu8")
                    ],
                    [
        ...
        try:
            ...
            await send_stored_file.reply_text(
                f"**Here is Sharable Link of this file:** https://t.me/{Config.BOT_USERNAME}?start=movie_360hub_{file_id}\n\n__To Retrive the Stored File, just open the link!__",
...
async def main(bot: Client, message: Message):
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/Movie360hub)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=movie_360hub_{file_er_id}"
            await editable.edit(
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://i.extraimages.net/images/2021/06/26/FB_IMG_1623499975507.jpg")
                    ],
                    [
